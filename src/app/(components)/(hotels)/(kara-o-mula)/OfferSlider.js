...
export default function OfferSlider({ nav }) {
  ...
  const slider = [
    {
      image: "/hotels/kara-o-mula/offers/slider/offer1.jpeg",
    ...
    {
      image: "/hotels/kara-o-mula/offers/slider/offer2.jpeg",
      url:"/hotels/kara-o-mula/offers/early-bird",
    ...
    {
      image: "/hotels/kara-o-mula/offers/slider/offer3.jpeg",
      url:"/hotels/kara-o-mula/offers/early-bird",
  ...
  return (
    <div className="w-full mt-5">
      ...
      <Swiper
        modules={[Autoplay]} 
        spaceBetween={0}pace between slides
        slidesPerView={1}
        loop={true}
