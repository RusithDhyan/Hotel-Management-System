...
const hotels = [
  {
    ...
    url: "/hotels/blue-waters/accommodations/executive-suite",
    description:
  ...
  },
  {
    ...
    url: "/hotels/blue-waters/accommodations/family-twin",
    description:
      "For those seeking extra space and comfort, the Executive Suite offers a separate living area and bedroom, creating a private and sophisticated ambiance.",
  },
  {
    ...
    url: "/hotels/blue-waters/accommodations/deluxe-king",
    description:
      "For those seeking extra space and comfort, the Executive Suite offers a separate living area and bedroom, creating a private and sophisticated ambiance.",
  },
  {
    ...
    url: "/hotels/blue-waters/accommodations/premier",
    description:
...
export default function Accommodation() {
  ...
  return (
    <div>
      ...
      <div>
        <Link
          href="/hotels/blue-waters/accommodations"
