  ...
  return (
    <div className="mt-10 flex flex-col items-center">
      <div className="flex flex-col items-center justify-center w-150">
        ...
        <Link href="/hotels/kambiri-beach/dining" className="text-sm lg:text-lg md:text-md">
      ...
      <div className="flex flex-row items-center justify-center gap-10 py-10 px-10">
        <Image
          src="/hotels/kambiri/foods/food-img1.jpeg"
          alt="food-img1"
          width={1000}
          height={100}
        ...
        />
        <Image
          src="/hotels/kambiri/foods/food-img2.jpeg"
          alt="food-img2"
          width={1000}
          height={100}
          className="w-80 h-80 object-cover"
        />
        <Image
          src="/hotels/kambiri/foods/food-img3.jpeg"
          alt="food-img3"
          width={1000}
          height={100}
          className="w-80 h-80 object-cover"
