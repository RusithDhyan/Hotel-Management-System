  ...
  return (
    <div className="mt-10 flex flex-col items-center px-4 sm:px-6 md:px-10">
      <div className="flex flex-col items-center justify-center w-full max-w-3xl text-center">
        ...
        <Link href="/hotels/waters-edge/dining" className="text-sm lg:text-lg md:text-md mt-4">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center md:gap-10 gap-3 py-10 w-full">
        <Image
          src="/hotels/waters-edge/foods/food-img1.jpeg"
          alt="food-img1"
          width={1000}
          height={100}
        ...
        />
        <Image
          src="/hotels/waters-edge/foods/food-img2.jpeg"
          alt="food-img2"
          width={1000}
          height={100}
          className="w-full sm:w-64 md:w-80 h-64 md:h-80 object-cover"
        />
        <Image
          src="/hotels/waters-edge/foods/food-img3.jpeg"
          alt="food-img3"
          width={1000}
          height={100}
          className="w-full sm:w-64 md:w-80 h-64 md:h-80 object-cover"
