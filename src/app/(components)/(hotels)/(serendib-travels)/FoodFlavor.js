  ...
  return (
    <div className="mt-10 flex flex-col items-center px-4">
      <div className="flex flex-col items-center justify-center w-full max-w-4xl text-center gap-4">
        ...
        <Link href="/hotels/serendib-travels/dining">
        <button
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10 py-10">
        <Image
          src="/hotels/serendib-travels/foods/food-img1.jpeg"
          alt="food-img1"
          width={1000}
          height={100}
        ...
        />
        <Image
          src="/hotels/serendib-travels/foods/food-img2.jpeg"
          alt="food-img2"
          width={1000}
          height={100}
          className="w-full md:w-80 h-64 md:h-80 object-cover"
        />
        <Image
          src="/hotels/serendib-travels/foods/food-img3.jpeg"
          alt="food-img3"
          width={1000}
          height={100}
          className="w-full md:w-80 h-64 md:h-80 object-cover"
