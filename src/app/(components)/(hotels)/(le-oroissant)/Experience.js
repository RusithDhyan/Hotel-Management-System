    ...
    <div>
      <div className="flex flex-row items-center justify-center gap-10 pt-10">
        <div className="flex flex-col w-100 items-center justify-center gap-5 p-2">
          <Image
            src="/hotels/le-croissant/le-croissant-img2.jpeg"
            alt="le-croissant-img2"
            width={1000}
            height={100}
        ...
        <div className="flex flex-col items-center justify-center mt-30 gap-2 relative overflow-hidden group">
          <h1 className="text-3xl">Experience in Le Croissant</h1>
          <div className="relative overflow-hidden group">
            <Image
              src="/hotels/le-croissant/le-croissant-img3.jpeg"
              alt="le-croissant-img3"
              width={1000}
              height={100}
