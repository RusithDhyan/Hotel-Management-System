...
const slider = [
  {
    image: "/hotels/bamboo-boutique/offers/slider/offer1.jpeg",
  ...
  {
    image: "/hotels/bamboo-boutique/offers/slider/offer2.jpeg",
    url:"/hotels/bamboo-boutique/offers/early-bird",
  ...
  {
    image: "/hotels/bamboo-boutique/offers/slider/offer3.jpeg",
    url:"/hotels/bamboo-boutique/offers/early-bird",
        ...
        {slider.map((slide, idx) => (
          <SwiperSlide key={idx}>
            <div className="flex flex-col sm:flex-row gap-5 mt-10">
              ...
              <iv className="flex flex-col items-center gap-2 text-sm md:text-md lg:text-lg text-center sm:text-left pt-30">
