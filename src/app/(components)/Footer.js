...
export default function Footer() {
  return (
    <div className="w-full bottom-0 top-0">
      <div className="border-t w-full p-6 mt-10 flex flex-col md:flex-row sm:items-center md:items-center lg:items-start justify-between md:justify-start gap-5 ">
