    ...
    <div className="w-full bottom-0 top-0">
      <div className="w-full p-6 flex flex-col md:flex-row sm:items-center md:items-center lg:items-start justify-between md:justify-start gap-5 ">
        ...
        <div className="flex-[1] flex flex-col items-center">
          <Link href="/" className="text-xs sm:text-sm md:text-md lg:text-lg xl:text-xl">
            Home
          </Link>
          <Link
        ...
        <div className="flex-[2]">
          <h1 className="text-xs sm:text-sm md:text-md lg:text-lg xl:text-xl text-center">Join our newsletter for the latest updates!</h1>
          <div className="flex flex-row gap-2 mt-3 justify-center">
            <input className="bg-gray-300 text-gray-600 p-2" placeholder="Enter your name"/>
      ...
      <div className="w-full bg-black text-white px-5 flex flex-row items-center justify-center h-10 gap-1">
        ...
        <h5 className="text-xs lg:text-lg md:text-md xl:text-xl">
          2025 Serandib Hotels.All Rights Rederverd | Design & Developed By Perl Vista
        </h5>
      </div>
    </div>
  );
