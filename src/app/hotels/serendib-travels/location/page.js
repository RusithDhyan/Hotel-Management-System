...
export default function Location() {
  ...
  const locations = [
    { id: 1, image: "/hotels/serendib-travels/location/feature1.jpg" },
    { id: 2, image: "/hotels/serendib-travels/location/feature2.jpg" },
    { id: 3, image: "/hotels/serendib-travels/location/feature3.jpg" },
    { id: 4, image: "/hotels/serendib-travels/location/feature4.jpg" },
  ];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center gap-3 mt-10 px-4 md:px-20 text-center">
        <p className="font-extralight text-sm md:text-base">
          Nestled in the tranquil Namiwawa neighborhood of Blantyre, Serendib
          Suites & Conference Center offers a harmonious blend of comfort and
          convenience. Ideal for both business and leisure travelers, the hotel
          features well-appointed rooms, a refreshing outdoor pool, and a
          renowned on-site restaurant, The Bay Leaf. With its serene ambiance
          and modern amenities, Serendib Suites provides a welcoming retreat in
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between mt-10 gap-5 px-4 md:px-10">
        <div className="flex flex-col md:flex-row gap-2 w-full lg:w-2/3">
          <Image
            src="/hotels/serendib-travels/location/image1.jpg"
            alt=""
            width={1000}
            height={100}
          ...
          />
          <Image
            src="/hotels/serendib-travels/location/image2.jpeg"
            alt=""
            width={1000}
            height={100}
            className="w-full md:w-1/2 h-52 object-cover"
