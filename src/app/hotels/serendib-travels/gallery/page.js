  ...
  const blogPosts = [
    {
      ...
      description: "Enjoy an exquisite selection of dishes crafted by our expert chefs.",
    ...
    },
    {
      ...
      description: "Discover the elegance and comfort of our hotel with world-class amenities.",
    ...
    },
    {
      ...
      description: "Explore beautiful sites and local experiences just minutes away from our hotel.",
    ...
    },
    {
      ...
      description: "Make your next trip unforgettable with these expert tips and tricks.",
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {blogPosts.map((post) => (
          <Link
            href={post.url}
            key={post.id}
            className="bg-white shadow-md hover:shadow-lg transition rounded overflow-hidden group"
          >
