...
export default function Location() {
  ...
  const locations = [
    { id: 1, image: "/hotels/kara-o-mula/location/feature1.jpg" },
    { id: 2, image: "/hotels/kara-o-mula/location/feature2.jpg" },
    { id: 3, image: "/hotels/kara-o-mula/location/feature3.jpg" },
    { id: 4, image: "/hotels/kara-o-mula/location/feature4.jpg" },
  ];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center gap-3 mt-10 px-4 md:px-20 text-center">
        <p className="font-extralight text-sm md:text-base">
          Nestled at the foot of the magnificent Mulanje Mountain, Kara O’Mula
          Country Lodge is located in the picturesque town of Mulanje in
          southern Malawi. Just a short drive from Blantyre, this peaceful
          retreat offers breathtaking views, cool mountain air, and easy access
          to tea estates, hiking trails, and cultural experiences.
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between mt-10 gap-5 px-4 md:px-10">
        <div className="flex flex-col md:flex-row gap-2 w-full lg:w-2/3">
          <Image
            src="/hotels/kara-o-mula/location/image1.jpeg"
            alt=""
            width={1000}
            height={100}
          ...
          />
          <Image
            src="/hotels/kara-o-mula/location/image2.jpeg"
            alt=""
            width={1000}
            height={100}
            className="w-full md:w-1/2 h-52 object-cover"
        ...
        <div className="flex flex-col justify-center gap-3 w-full lg:w-1/3 text-sm md:text-base">
          ...
          <p className="text-justify">
            Escape to the tranquil charm of Kara O'Mula, beautifully set at the
            base of Mulanje Mountain in southern Malawi. Surrounded by lush
            greenery and tea plantations, it’s the perfect base for mountain
            adventures or a relaxing getaway with stunning views and fresh
            highland breezes.
          </p>
