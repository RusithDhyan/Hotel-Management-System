...
export default function Location() {
  ...
  const locations = [
    { id: 1, image: "/hotels/le-croissant/location/feature1.jpg" },
    { id: 2, image: "/hotels/le-croissant/location/feature2.jpg" },
    { id: 3, image: "/hotels/le-croissant/location/feature3.jpg" },
    { id: 4, image: "/hotels/le-croissant/location/feature4.jpg" },
  ];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center gap-3 mt-10 px-4 md:px-20 text-center">
        <p className="font-extralight text-sm md:text-base">
          Located in the Heart of Lilongwe Nestled in the vibrant capital city
          of Malawi, Le Croissant is perfectly situated in the bustling center
          of Lilongwe. Just minutes from top hotels, embassies, and business
          hubs, our café offers a cozy yet refined escape for locals and
          travelers alike. Whether you're looking for a quiet morning coffee or
          a convenient midday meeting spot, Le Croissant brings Parisian flair
          to the heart of Malawi.
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between mt-10 gap-5 px-4 md:px-10">
        <div className="flex flex-col md:flex-row gap-2 w-full lg:w-2/3">
          <Image
            src="/hotels/le-croissant/location/image1.jpeg"
            alt=""
            width={1000}
            height={100}
          ...
          />
          <Image
            src="/hotels/le-croissant/location/image2.jpeg"
            alt=""
            width={1000}
            height={100}
            className="w-full md:w-1/2 h-52 object-cover"
        ...
        <div className="flex flex-col justify-center gap-3 w-full lg:w-1/3 text-sm md:text-base">
          <h1 className="text-xl md:text-2xl font-semibold text-center lg:text-left">
            A Taste of France in Lilongwe
          </h1>
          <p className="text-justify">
            Find us right in Lilongwe, Malawi’s lively capital! Le Croissant
            sits in a charming corner of the city, surrounded by friendly
            neighborhoods and city life. It’s the perfect spot to grab a buttery
            croissant, sip a cappuccino, and relax — whether you're on your
            lunch break, meeting friends, or just exploring town.
          </p>
        </div>
      </div>
