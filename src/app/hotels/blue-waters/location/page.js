...
export default function Location() {
  ...
  const locations = [
    { id: 1, image: "/hotels/blue-waters/location/feature1.jpg" },
    { id: 2, image: "/hotels/blue-waters/location/feature2.jpg" },
    { id: 3, image: "/hotels/blue-waters/location/feature3.jpg" },
    { id: 4, image: "/hotels/blue-waters/location/feature4.jpg" },
  ];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center gap-3 mt-10 px-4 md:px-20 text-center">
        <p className="font-extralight text-sm md:text-base">
          Blue Waters is a stunning lakeside resort located on the shores of
          Lake Malawi in Salima. It offers breathtaking views, serene beaches,
          and a relaxing atmosphere, making it a perfect escape for nature
          lovers and holiday seekers alike.
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between mt-10 gap-5 px-4 md:px-10">
        <div className="flex flex-col md:flex-row gap-2 w-full lg:w-2/3">
          <Image
            src="/hotels/blue-waters/location/image1.jpeg"
            alt=""
            width={1000}
            height={100}
          ...
          />
          <Image
            src="/hotels/blue-waters/location/image2.jpeg"
            alt=""
            width={1000}
            height={100}
            className="w-full md:w-1/2 h-52 object-cover"
        ...
        <div className="flex flex-col justify-center gap-3 w-full lg:w-1/3 text-sm md:text-base">
          ...
          <p className="text-justify">
            Nestled along the golden sands of Lake Malawi's shoreline in Salima,
            Blue Waters is a peaceful resort destination that blends tropical
            charm with modern comfort. Just a short drive from Lilongwe, it
            offers panoramic views of the lake, vibrant sunsets, and easy access
            to water activities like swimming, kayaking, and boat rides.
            Surrounded by lush gardens and palm trees, it’s an ideal retreat for
            couples, families, and solo travelers seeking tranquility and
