    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center gap-3 mt-10 px-4 md:px-20 text-center">
        <p className="font-extralight text-sm md:text-base">
          Kambiri Beach is your perfect getaway — nestled on the golden sands of
          Lake Malawi, just a short drive from Lilongwe. With crystal-clear
          waters, gentle waves, and the charm of Salima town nearby, it's the
          ultimate spot to relax, recharge, and reconnect with nature.
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between mt-10 gap-5 px-4 md:px-10">
        ...
        <div className="flex flex-col justify-center gap-3 w-full lg:w-1/3 text-sm md:text-base">
          ...
          <p className="text-justify">
            At Kambiri Beach, that dream comes true! Located along the stunning
            shoreline of Lake Malawi in Salima District, this hidden gem is
            surrounded by natural beauty, vibrant local culture, and
            unforgettable lake views. Just minutes from Senga Bay, it’s where
