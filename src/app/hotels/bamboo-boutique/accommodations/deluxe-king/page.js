...
export default function Delux() {
  ...
  const hotels = [
    {
      id: 1,
      image: "/hotels/heritage/accommodations/deluxe/feature1.jpg",
    },
    {
      id: 2,
      image: "/hotels/heritage/accommodations/deluxe/feature2.jpg",
    },
    {
      id: 3,
      image: "/hotels/heritage/accommodations/deluxe/feature3.jpg",
    },
    {
      id: 4,
      image: "/hotels/heritage/accommodations/deluxe/feature4.jpg",
    },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="w-full h-auto relative group">
        <Image
          src="/hotels/heritage/accommodations/deluxe/deluxe-bg1.jpg"
          alt=""
          width={1500}
          height={100}
