  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="w-full h-auto relative">
        <Image
          src="/hotels/bamboo-boutique/offers/family-vacation/bg.jpg"
      ...
      <div className="flex flex-col items-center justify-center gap-3 mt-10 px-10">
        <h1 className="text-2xl">Family Vacation Offer at Le Croissant</h1>
      ...
      <div className="flex flex-row items-center justify-center gap-4 mt-10 px-10">
        <Image
          src="/hotels/bamboo-boutique/offers/family-vacation/bg-img.jpg"
          alt="family-vacation-img"
          width={1000}
          height={100}
