...
export default function FamilyTwin() {
  ...
  const hotels = [
    { id: 1, image: "/hotels/heritage/accommodations/family/feature1.jpg" },
    { id: 2, image: "/hotels/heritage/accommodations/family/feature2.jpg" },
    { id: 3, image: "/hotels/heritage/accommodations/family/feature3.jpg" },
    { id: 4, image: "/hotels/heritage/accommodations/family/feature4.jpg" },
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="w-full relative">
        <Image
          src="/hotels/heritage/accommodations/family/family-bg3.jpg"
          alt=""
          width={1500}
          height={500}
