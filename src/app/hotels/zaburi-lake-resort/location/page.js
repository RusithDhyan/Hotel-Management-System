...
export default function Location() {
  ...
  const locations = [
    { id: 1, image: "/hotels/zaburi-lake/location/feature1.jpg" },
    { id: 2, image: "/hotels/zaburi-lake/location/feature2.jpg" },
    { id: 3, image: "/hotels/zaburi-lake/location/feature3.jpg" },
    { id: 4, image: "/hotels/zaburi-lake/location/feature4.jpg" },
  ];
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center gap-3 mt-10 px-4 md:px-20 text-center">
        <p className="font-extralight text-sm md:text-base">
          Nestled along the tranquil shores of Lake Malawi, Zaburi Lake Resort
          offers a picturesque escape in the heart of Mangochi. Just a few
          hours’ drive from the city of Blantyre, this lakeside gem is perfectly
          positioned for those seeking both adventure and relaxation. With
          golden beaches, stunning sunsets, and a warm tropical breeze, the
          resort is an ideal base for exploring Malawi’s natural beauty.
        </p>
      </div>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between mt-10 gap-5 px-4 md:px-10">
        <div className="flex flex-col md:flex-row gap-2 w-full lg:w-2/3">
          <Image
            src="/hotels/zaburi-lake/location/image1.jpeg"
            alt=""
            width={1000}
            height={100}
          ...
          />
          <Image
            src="/hotels/zaburi-lake/location/image2.jpeg"
            alt=""
            width={1000}
            height={100}
            className="w-full md:w-1/2 h-52 object-cover"
        ...
        <div className="flex flex-col justify-center gap-3 w-full lg:w-1/3 text-sm md:text-base">
          <h1 className="text-xl md:text-2xl font-semibold text-center lg:text-left">
            Hidden Paradise by the Lake{" "}
          </h1>
          <p className="text-justify">
            Located on the southern tip of Lake Malawi, in the Mangochi
            District, Zaburi Lake Resort is surrounded by breathtaking views and
            lush landscapes. Its unique location provides easy access to nearby
            cultural attractions, nature reserves, and water activities. Whether
            you're kayaking at sunrise or enjoying fresh fish by the beach,
            every moment here connects you deeper to Malawi’s charm.
          </p>
        </div>
      </div>
