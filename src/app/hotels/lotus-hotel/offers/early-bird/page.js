  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="w-full h-auto relative">
        <Image
          src="/hotels/lotus-hotel/offers/early-bird/bg.jpg"
          alt="early-bird-img"
          width={1500}
          height={100}
      ...
      <div className="flex flex-col items-center justify-center gap-3 mt-10 px-4 sm:px-10 text-center">
        <h1 className="text-xl sm:text-2xl">Early Bird Offer at Lotus Hotel</h1>
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-6 mt-10 px-4 sm:px-10">
        <Image
          src="/hotels/lotus-hotel/offers/early-bird/bg-img.jpg"
          alt="early-bird-img"
          width={1000}
          height={100}
